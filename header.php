...
<body>
	...
	<section class="s-mob-panel">

		<div class="cities-chooser">
			<a href="/" class="cities-chooser__current fancy-modal" rel="nofollow" data-src="#modal-cities">Главная</a>
		</div>
		...
		<div class="mob-menu-static">
			<p class="mob-menu-static__title">Online shop</p>
			<ul>
		...
		<div class="mob-menu-static">
			<p class="mob-menu-static__title">Информация</p>
			<ul>
					...
					<div class="top-basket">
						<div class="top-basket-items">
							<div class="top-basket-item">
								<a href="#">
									<img src="/img/top-basket.jpg" alt="111">
								</a>
								<div class="top-basket-item__content">
									<p class="top-basket-item__title"><a href="#">Ремень мужской BB1 ORIGINAL</a></p>
									<div class="top-basket-item__param">арт. 940119</div>
									<div class="top-basket-item__param">Цвет: Красный темный крокодил</div>
									<div class="top-basket-item__param">Количество: 1 шт</div>
								</div>
							</div>
						</div>
